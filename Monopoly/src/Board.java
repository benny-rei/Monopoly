...
public class Board {
	...
	public void fillBoard(){
		...
		fields[2] = new Action("COMMUNITY CHEST", "lalalalallalalalalalalal");
		
		fields[3] = new Property("Baltic Avenue", 1, null, 40, rent1, false);
		
		fields[4] = new Action("Income Tax", "pay 300 dollars");
		...
		fields[12] = new Action("Electric Company", " Pay 150€");
		...
		fields[17] = new Action("Community Chest", "Follow Instructions of the Card");
		...
		fields[28] = new Action("Water Works", " Pay 150€");
